...
class WaveGANGenerator(nn.Module):
    def __init__(self, model_size=64, ngpus=1, num_channels=1,
                 latent_dim=256, post_proc_filt_len=512,
    ...
    def forward(self, x, image_rep):
        x = torch.add(x, image_rep)
...
# class WaveGANDiscriminator512(nn.Module):
#     def __init__(self, model_size=64, ngpus=1, num_channels=1, shift_factor=2,
#                  alpha=0.2, verbose=False):
#         super(WaveGANDiscriminator512, self).__init__()
#         self.model_size = model_size  # d
#         self.ngpus = ngpus
#         self.num_channels = num_channels  # c
#         self.shift_factor = shift_factor  # n
...
#         self.fc1 = nn.Linear(256 * model_size, 512)
